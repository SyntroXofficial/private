export const steamAccounts = [
  ...
  },
  {
    ...
    requirements: {
      ...
      gpu: 'AMD RX 6700 XT or NVIDIA RTX 3070',
      ram: '16 GB',
      storage: '100 GB SSD'
    },
    rarity: 'mythic'
  },
  {
    ...
    username: 'seetenater1986',
    password: 'SvW6XFWHws1988',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1643320/header.jpg',
    description: '• Full Game Access\n• Early Access Content\n• All Weapons & Equipment\n• Special Edition Items\n• Exclusive Pre-order Bonuses\n• Survival Mode Access',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
      { label: 'Rating', value: 'M (Mature)' },
      { label: 'Genre', value: 'FPS/Survival' },
      { label: 'Release', value: '2024' },
  ...
  },
  {
    ...
    password: 'WATCH@2029',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2239550/header.jpg',
    description: '• Full Game Access\n• All DLC Content\n• Season Pass\n• Online Features\n• All Characters\n• Special Operations',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
    ...
    requirements: {
      ...
      gpu: 'NVIDIA RTX 2060S or AMD RX 5700',
      ram: '16 GB',
      storage: '100 GB SSD'
    },
    rarity: 'mythic'
  ...
  // Legendary Accounts
  {
    ...
    requirements: {
      ...
      gpu: 'AMD RX 5700 XT or NVIDIA RTX 2060 SUPER',
      ram: '16 GB',
      storage: '150 GB SSD'
    },
    rarity: 'legendary'
  ...
  {
    game: 'Dragons Dogma 2 Deluxe Edition',
    username: 'mksir82042',
    password: 'exlk66954F',
    imageUrl: 'https://image.api.playstation.com/vulcan/ap/rnd/202311/1309/746f848d0be7107e301df1142745b334b64fbc87c218e3b1.jpg',
    ...
    features: [
      ...
      { label: 'Genre', value: 'Action RPG' },
      { label: 'Release', value: '2024' },
      { label: 'Playtime', value: '80+ hours' }
    ],
    requirements: {
      cpu: 'AMD Ryzen 5 3600X or Intel Core i7-9700',
  ...
  },
  {
    game: 'NBA 2K24',
    username: 'mic0205',
    password: 'gamerenkk1313!!',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2338770/header.jpg',
    description: '• Full Game Access\n• All Teams Unlocked\n• MyTEAM Content\n• Online Features\n• Career Mode\n• Special Edition Items',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
  ...
  },
  {
    ...
    description: '• Complete Trilogy Access\n• All DLC Locations\n• Unlocked Equipment\n• All Campaign Missions\n• Bonus Missions\n• Escalation Contracts',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
      { label: 'Rating', value: 'M (Mature)' },
      { label: 'Genre', value: 'Stealth' },
      { label: 'Release', value: '2023' },
      { label: 'Playtime', value: '100+ hours' }
    ],
    requirements: {
  ...
  },
  {
    game: 'Dead Island 2',
    username: 'pakalo63',
    password: 'MUGapGqA5hYe',
    imageUrl: 'https://cdn.wccftech.com/wp-content/uploads/2023/02/DI2.jpeg',
    description: '• Full Game Access\n• All Characters Unlocked\n• Bonus Weapons Pack\n• Special Abilities\n• All Areas Available\n• Multiplayer Access',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
    ...
    requirements: {
      cpu: 'AMD Ryzen 5 5600X or Intel i5-10600K',
      gpu: 'AMD RX 6600 XT or NVIDIA RTX 2070',
      ram: '16 GB',
      storage: '70 GB SSD'
    },
    rarity: 'legendary'
  },
  {
    ...
    username: 'dakotabell2010',
    password: 'scooter_123',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1846380/header.jpg',
  ...
  // Epic Accounts
  {
    ...
    features: [
      ...
      { label: 'Rating', value: 'M (Mature)' },
      { label: 'Genre', value: 'Action RPG' },
      { label: 'Release', value: '2015' },
      { label: 'Playtime', value: '100+ hours' }
    ],
    requirements: {
      cpu: 'Intel Core i5-2500K or AMD FX-8350',
      gpu: 'NVIDIA GTX 770 or AMD Radeon RX 480',
      ram: '8 GB',
      storage: '50 GB'
    },
    rarity: 'epic'
  },
  {
    ...
    username: '93612408',
    password: '07545306',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/949230/header.jpg',
    description: '• Full Game Access\n• All DLC Content\n• All Building Packs\n• Modding Support\n• Scenario Editor\n• Workshop Access',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
      { label: 'Rating', value: 'E (Everyone)' },
      { label: 'Genre', value: 'City Builder' },
      { label: 'Release', value: '2023' },
      { label: 'Playtime', value: '50+ hours' }
    ],
    requirements: {
      cpu: 'Intel Core i7-6700K or AMD Ryzen 5 3600',
      gpu: 'NVIDIA RTX 2080 or AMD RX 6700 XT',
      ram: '16 GB',
      storage: '60 GB SSD'
    },
    rarity: 'epic'
  },
  {
    ...
    features: [
      ...
      { label: 'Platform', value: 'Steam' },
      { label: 'Rating', value: 'T (Teen)' },
      { label: 'Genre', value: 'Space Exploration' },
  ...
  },
  {
    ...
    requirements: {
      cpu: 'AMD Ryzen 5 3600X or Intel Core i7-8700K',
      gpu: 'AMD RX 5700 XT or NVIDIA RTX 2070',
      ram: '16 GB',
      storage: '60 GB SSD'
    },
    rarity: 'epic'
  },
  {
    ...
    username: 'ghosttsushima5',
    password: '7JAN3Q!F!7EW',
    imageUrl: 'https://helios-i.mashable.com/imagery/articles/00iMVz5oU69RK9UEoPsZTMW/hero-image.fill.size_1248x702.v1623390188.jpg',
    ...
    requirements: {
      cpu: 'AMD Ryzen 5 3600 or Intel Core i5-10400',
      gpu: 'AMD RX 5700 or NVIDIA RTX 2060 SUPER',
      ram: '16 GB',
      storage: '75 GB SSD'
    },
    rarity: 'epic'
  },
  {
    game: 'Ready or Not',
    username: 'tets64960',
    password: 'Iw5Cc1On0Ff16t',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1144200/header.jpg',
    description: '• Full Game Access\n• All Maps\n• Multiplayer Access\n• All Equipment\n• Special Items\n• Supporter Edition',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
  ...
  },
  {
    ...
    username: 'zbyszekch71',
    password: 'FunpayMysxla',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/476600/header.jpg',
    description: '• Full Game Access\n• All DLC Maps\n• Multiplayer Access\n• Zombie Mode\n• Campaign Mode\n• Special Weapons',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
    ...
    requirements: {
      cpu: 'Intel Core i5-2400 or AMD Ryzen 5 1600',
  ...
  },
  {
    game: 'Atomic Heart',
    username: 'gaby_idf',
    password: 'AtomicHeartFunpayTrashSergey',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/668580/header.jpg',
    description: '• Full Game Access\n• All Weapons\n• All Areas Unlocked\n• Special Abilities\n• Premium Content\n• Bonus Items',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
  ...
  {
    game: 'Dying Light 2: Reloaded Edition',
    username: 'rehuidwswgq171',
    password: 'qwerf2625',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/534380/header.jpg',
    description: '• Full Game Access\n• All DLCs\n• Multiplayer Access\n• Special Weapons\n• Bonus Content\n• Season Pass',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Platform', value: 'Steam' },
      { label: 'Rating', value: 'E (Everyone)' },
      { label: 'Genre', value: 'Vehicle Simulation' },
      { label: 'Release', value: '2015' },
      { label: 'Playtime', value: '50+ hours' }
    ],
    requirements: {
  ...
  // Rare Accounts
  {
    ...
    game: 'Stray',
    username: 'Brahminsnare323',
    password: 'xCZStAudn0Cs',
    ...
    requirements: {
      ...
      gpu: 'NVIDIA GTX 780 or AMD RX 470',
      ram: '8 GB',
      storage: '10 GB'
    },
    rarity: 'rare'
  },
  {
    ...
    requirements: {
      cpu: 'Intel Core i3-3220 or AMD Phenom II X4',
      gpu: 'NVIDIA GTX 650 or AMD HD 7750',
      ram: '4 GB',
      storage: '8 GB'
    },
    rarity: 'rare'
  },
  {
    ...
    username: 'galyakushilenko1991',
    password: 'IXi4M1lOVlsNprrr5',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/860510/header.jpg',
    description: '• Full Game Access\n• All Chapters\n• Bonus Content\n• Digital Artbook\n• Soundtrack\n• Special Items',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
      { label: 'Rating', value: 'T (Teen)' },
      { label: 'Genre', value: 'Horror Adventure' },
      { label: 'Release', value: '2021' },
      { label: 'Playtime', value: '15+ hours' }
    ],
    requirements: {
      cpu: 'Intel Core i5-2300 or AMD FX-4350',
      gpu: 'NVIDIA GTX 570 or AMD HD 7850',
      ram: '4 GB',
      storage: '30 GB'
    },
    rarity: 'rare'
  ...
  },
  {
    ...
    username: 'kubix_2121',
    password: 'PIKZmVxVrF9A',
    imageUrl: 'https://cdn.cloudflare.steamstatic.com/steam/apps/848450/header.jpg',
    description: '• Full Game Access\n• All Areas Unlocked\n• Survival Mode\n• Freedom Mode\n• Creative Mode\n• Hardcore Mode',
    features: [
      { label: 'Region', value: 'Global' },
      { label: 'Platform', value: 'Steam' },
      { label: 'Rating', value: 'E (Everyone)' },
      { label: 'Genre', value: 'Survival Adventure' },
      { label: 'Release', value: '2021' },
      { label: 'Playtime', value: '40+ hours' }
    ],
    requirements: {
