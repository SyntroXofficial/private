  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-6">
      <div className="max-w-md mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold text-red-500 mb-4">Welcome to Prime Nexo</h1>
        ...
        >
          <button
            ...
            className="w-full py-3 bg-[#5865F2] hover:bg-[#4752C4] rounded-lg text-white transition-all duration-300 flex items-center justify-center gap-2"
          >
