...
export default function BanModal({ isOpen, onClose, onBan, username }) {
      ...
      >
        ...
        >
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-2xl font-bold text-red-500">Ban Member</h3>
            <button
              onClick={onClose}
            ...
            <div className="flex items-start gap-3 p-4 bg-red-500/10 rounded-lg border border-red-500/30">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  You are about to ban <span className="font-semibold text-white">{username}</span>. 
                  This action will:
                </p>
                <ul className="mt-2 space-y-1 text-sm text-gray-400">
                  <li>• Block their access to all services</li>
                  <li>• Log their device fingerprint</li>
                  <li>• Record this action in security logs</li>
                </ul>
              </div>
            </div>
